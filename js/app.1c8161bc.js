  ...
  var e = {
      4766: function (e, t, n) {
              ...
              e.personLoaded
                ...
                : ((0, o.wg)(),
                  (0, o.iD)(
                    "div",
                    p,
                    " Connexion à internet...! Merci de patienter "
                  )),
            ])
          );
        }
        ...
        const A = (e) => (
          ...
          z = A(() => (0, o._)("label", { for: "telephone" }, "Téléphone", -1)),
        ...
        const Te = (e) => (
          ...
          we = Te(() =>
            (0, o._)(
              "p",
              null,
              "CIN ou Téléphone ou email déjà enregistré dans la base de données",
              -1
            )
          ),
          Ae = Te(() =>
            (0, o._)("p", null, "Veuillez véfier s'il vous plait", -1)
          ),
        ...
        const et = (e) => (
          ...
          at = et(() =>
            (0, o._)(
              "label",
              { for: "numero" },
              "Numéro / N° Identification / Email / CIN / Numéro téléphone",
              -1
            )
          ),
        ...
        const At = (e) => (
          ...
          It = { class: "text-red" },
          Ct = (0, o.Uk)(" dans votre Base de Données ");
        ...
        const Vt = (e) => (
          ...
          nn = { class: "right flex" },
          sn = { class: "data flex" },
          on = Vt(() => (0, o._)("div", { class: "left flex" }, "Numéro", -1)),
          rn = { class: "right flex" },
          ln = { class: "data flex" },
          an = Vt(() =>
            (0, o._)("div", { class: "left flex" }, "Nom et Prénom", -1)
          ),
          dn = { class: "right flex" },
          cn = { class: "data flex" },
          ...
          mn = { class: "data flex" },
          vn = Vt(() =>
            (0, o._)("div", { class: "left flex" }, "Numéro téléphone", -1)
          ),
          En = { class: "right flex" },
          On = { class: "data flex" },
          ...
          An = { key: 0, class: "desc" },
          Sn = Vt(() =>
            (0, o._)("div", { class: "desc-left flex" }, "Déscripton", -1)
          ),
        ...
        const Mn = (e) => (
          ...
          Kn = Mn(() => (0, o._)("h1", null, "Les validés à entrer", -1)),
          Hn = (0, o.Uk)("Total des personnes valideés : "),
          zn = { class: "right flex" },
            ...
            filterPersons(e) {
              (this.filterPerson =
                ...
                "Tous" == e.target.innerText &&
                  ((this.filterPerson = null),
                  (this.filteredData = this.personData)),
                "Validé" == e.target.innerText &&
                  (this.filteredData = this.personData.filter((t) => {
                    if ("Validé" === e.target.innerText)
                      return "OUI" === t.validation;
                  })),
                "Non-validé" == e.target.innerText &&
                  (this.filteredData = this.personData.filter((t) => {
                    if ("Non-validé" === e.target.innerText)
        ...
        const Ks = (e) => (
          ...
          $s = Ks(() => (0, o._)("h1", null, "Les Personnes payées", -1)),
          js = (0, o.Uk)("Total des personnes payées : "),
          Bs = { class: "right flex" },
